function generateHTML(order) {
  ...
  const designsHTML = order.designs
    .map((design, index) => {
      return `
      ...
      <div style="border: 2px solid #000">
        ...
        <div style="border-bottom: 1px solid #000; display: flex; flex-direction: row;">
          <div style="width: 55%; border-right: 1px solid #000">
            <b>To:</b> ${order.billTo}<br />
            ${order.billToAddress}<br />
            MOB-98195505190/7506633188
          </div>
          <div style="width: 45%">
            <b>Delivery:</b> ${order.shipTo}<br />
            ${order.shipToAddress}<br />
            MOB-98195505190/7506633188
          </div>
        </div>
        <div style="border-bottom: 1px solid #000; display: flex; flex-direction: row;">
        ...
        <div style="display: flex; flex-direction: row; border-top: 1px solid #000; font-size: x-large;">
          ...
          <div style="width: 4%; border-right: 1px solid #000; font-weight: bold; text-align: center;">
            ${order.designs.reduce(
              (total, design) => total + design.shades.filter((s) => s).length,
              0
            )}
          </div>
...
console.log(generateHTML(orderData));
